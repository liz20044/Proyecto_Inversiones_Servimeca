...
$sql = "SELECT e.employee_id, e.firstname, e.lastname, p.amount FROM payroll p INNER JOIN  employees e ON p.employee_id = e.id";
...
$pdf->Ln(20);  
$pdf->Cell(190,5,utf8_decode("Recibo detallado de Pago de Nómina"), 0, 1,"C");
$pdf->Ln(10);  
...
$pdf->SetFillColor(233,229,235);
    ...
    //$pdf->Cell(30,8,utf8_decode('concepto'), 1, 1,"C",1);
...
while ($fila = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(40,8,utf8_decode($fila['amount']), 'B', 1,"C"); 
    //$pdf->Cell(30,8,$fila[' c.name'], 'B', 0,"C");
    //$pdf->Cell(30,8,$fila['time_out'], 'B', 1,"C");
