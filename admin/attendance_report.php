...
$sql = "SELECT e.employee_id, firstname, lastname, time_in, date, 	
time_out FROM attendance a INNER JOIN  employees e ON a.employee_id = e.id";
...
$pdf->Ln(20);  
$pdf->Cell(190,5,"Asistencias", 0, 1,"C");
$pdf->Ln(10);  
...
$pdf->SetFillColor(233,229,235);
    ...
    $pdf->Cell(40,8,utf8_decode('Fecha'), 1, 0,"C",1); 
...
while ($fila = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(40,8,utf8_decode($fila['date']), 'B', 0,"C"); 
