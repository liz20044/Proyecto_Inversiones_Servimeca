        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input class="form-control" type="text" name="customer_document" id="customer_document" required placeholder="V-39067823" maxlength="10">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
          		  ...
          		  <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="patent" name="patent" required placeholder="Ej. A32BC3" maxlength="10">
                  	</div>
                    </div>
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="brand" name="brand" required placeholder="Ej. Chevrolet" maxlength="20">
                  	</div>
                </div>
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="model" name="model" required placeholder="Ej. Corsa" maxlength="20">
                  	</div>
                </div>
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="color" name="color" required placeholder="Ej. Azul" maxlength="20">
                  	</div>
                </div>
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="engine" name="engine" required placeholder="Ej. V8-404" maxlength="20">
                  	</div>
                </div>
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="chassis" name="chassis" required placeholder="Ej. 123-CHA" maxlength="20" >
                  	</div>
                </div>
                <div class="form-group">
        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_patent" name="edit_patent" required maxlength="20">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_brand" name="edit_brand" required maxlength="20">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_model" name="edit_model" required maxlength="20">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_color" name="edit_color" required maxlength="20">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_engine" name="edit_engine" required maxlength="20">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_chassis" name="edit_chassis" required maxlength="20">
                    </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input class="form-control" type="text" name="edit_customer_document" id="edit_customer_document" required placeholder="V-39067823" maxlength="10">
                  </div>
                </div>
                <div class="form-group">
